...
CATEGORIES = {
    ...
    "utility": {
        ...
        "commands": [
            ...
            ("/uptime", "Bot uptime"),
            ("/profile view [@user]", "View a user's profile"),
            ("/profile set bio [text]", "Set your bio (max 200 chars)"),
            ("/profile set pronouns [text]", "Set your pronouns"),
            ("/profile set timezone [text]", "Set your timezone"),
        ],
    },
    "server": {
        "emoji": "ℹ️",
    ...
    "settings": {
        "emoji": "⚙️",
        "name": "Settings",
        "desc": "Welcome, goodbye, autorole, logging, bot status, AI mod role",
        "color": COLOR_DEFAULT,
        "commands": [
