...
class ModMail(commands.Cog):
    ...
    modmail = app_commands.Group(name="modmail", description="Modmail system management")

    @modmail.command(name="setup", description="Setup modmail system")
    ...
    @modmail.command(name="toggle", description="Enable or disable modmail")
    @app_commands.checks.has_permissions(administrator=True)
    ...
    @modmail.command(name="dm", description="Send a DM to a user (Admin only)")
    @app_commands.checks.has_permissions(administrator=True)
    async def modmail_dm(
        self,
        interaction: discord.Interaction,
        user: discord.Member,
        message: str,
    ...
    # ==================== Top-level /massdm (kept for convenience) ====================
...
class ReplyModal(discord.ui.Modal, title="Reply to User"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            reply_embed.set_footer(text=interaction.guild.name if interaction.guild else "Staff")
            ...
            try:
                ...
                await interaction.followup.send("Cannot DM this user.", ephemeral=True)
