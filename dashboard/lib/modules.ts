...
export const SIDEBAR: SidebarCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'vibe & fortune', route: 'ai#vibe', icon: 'sparkles', slug: 'ai' },
      { title: 'qotd', route: 'qotd', icon: 'helpCircle', slug: 'qotd' },
      { title: 'recap', route: 'ai#recap', icon: 'scroll', slug: 'ai' },
    ],
  },
  {
    label: 'moderation',
    ...
    items: [
      ...
      { title: 'warnings', route: 'moderation#warnings', icon: 'swords', slug: 'moderation' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'onboarding', route: 'roles#onboarding', icon: 'sparkles', slug: 'roles' },
  ...
  },
  {
    ...
    icon: 'users',
    items: [
      { title: 'autorole', route: 'roles#autorole', icon: 'sparkles', slug: 'roles' },
      { title: 'self-roles', route: 'roles#selfroles', icon: 'users', slug: 'roles' },
      { title: 'level rewards', route: 'leveling#rewards', icon: 'star', slug: 'leveling' },
      { title: 'color roles', route: 'roles#colors', icon: 'zap', slug: 'roles' },
    ],
  },
  {
    label: 'community',
    ...
    items: [
      ...
      { title: 'polls', route: 'fun', icon: 'helpCircle', slug: 'fun' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'danger zone', route: 'privacy#danger', icon: 'shieldAlert', slug: 'privacy' },
    ],
  },
];
